...
\section{Data}
Deep learning models are trained and tested in this work on an Artificial Lunar Dataset created by Romain Pessia and Genya Ishigami of the Space Robotics Group, Keio University, Japan. This data set contains 9766 images of a photorealistic lunar environment made using the Terragen software. Images and ground truth segmentation masks are provided in files with matching names.

\begin{figure}[h!]
    \centering
    \includegraphics[width=5.5cm]{dataset_examples/renders/render9679.png}
    \includegraphics[width=5.5cm]{dataset_examples/ground/ground9679.png}

    \includegraphics[width=5.5cm]{dataset_examples/renders/render9723.png}
    \includegraphics[width=5.5cm]{dataset_examples/ground/ground9723.png}

    \includegraphics[width=5.5cm]{dataset_examples/renders/render9688.png}
    \includegraphics[width=5.5cm]{dataset_examples/ground/ground9688.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=5.5cm]{dataset_examples/real/PCAM5.png}
    \includegraphics[width=5.5cm]{dataset_examples/real/g_PCAM5.png}

    \includegraphics[width=5.5cm]{dataset_examples/real/PCAM8.png}
    \includegraphics[width=5.5cm]{dataset_examples/real/g_PCAM8.png}

    \includegraphics[width=5.5cm]{dataset_examples/real/TCAM14.png}
    \includegraphics[width=5.5cm]{dataset_examples/real/g_TCAM14.png}
    \caption{Example real lunar images with corresponding segmentation masks}
    \label{fig:data_real_example1}
\end{figure}

% Tutaj dalej opisać też zbiór MarsData, nie jestem tylko pewien czy już tutaj opisywać jak te dane są przetwarzane ale raczej w późniejszej sekcji dotyczącej samego projektu
